...
const styles = StyleSheet.create({
  ...
  statEmoji: { fontSize: 22, lineHeight: 26, textAlign: 'center' },
  statValue: { fontSize: FONT_SIZE.xl, fontWeight: '800', color: COLORS.text, lineHeight: 28, textAlign: 'center' },
  statLabel: { fontSize: FONT_SIZE.xs, color: COLORS.textTertiary, textAlign: 'center' },
  todoRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: SPACING.sm,
